				...
				<div class="col-md-12">
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?= base_url('admin/Manage_Job/add'); ?>" class="btn btn-success">
                     ...
                     function deleteMe(id){
                        var c=confirm("Do you really want to remove this job?");
                        if(c==true)
                        {
                            var xmlhttp;
                                    ...
                                    xmlhttp.open("POST","<?= base_url(); ?>admin/Manage_Job/delete/"+id,true);
                                    xmlhttp.send();
                        }
                        else{
