		...
		<div class="page-content">
			...
			<div class="page-bar">
				...
				<div class="page-toolbar">
					<div class="pull-right tooltips btn btn-fit-height btn-primary" data-container="body" data-placement="bottom">
                        ...
                        <?php if($data['update']['status']=="false") { ?>
                        <div class="alert alert-danget alert-dismissible">
			...
			<div class="portlet">
                            ...
                            <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="<?= base_url('admin/My_Profile/update'); ?>" class="form-horizontal form-row-seperated" method="POST">
                                            <div class="form-body">
                                                    <div class="form-group">
                                                            <label class="control-label col-md-3">Name</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="name" placeholder="e.g John Dave" value="<?php echo($data['admin']['admin_name']); ?>" class="form-control"/>
                                                            </div>
                                                    </div>
                                                    <div class="form-group">
                                                            <label class="control-label col-md-3">Email</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="email" placeholder="e.g example@mail.com" value="<?php echo($data['admin']['admin_email']); ?>" class="form-control"/>
                                                            </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="contact" placeholder="e.g +x xxx-xxx-xxxx" class="form-control" value="<?php echo($data['admin']['admin_contact']); ?>" />
                                                            </div>
                                                    </div>
                                            ...
                                            <div class="form-actions">
                                                    <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                    ...
                                                                    <a href="<?= base_url('admin/My_Profile'); ?>" class="btn btn-default">Cancel</a>
                                                            </div>
                                                    </div>
                                            </div>
                                    </form>
