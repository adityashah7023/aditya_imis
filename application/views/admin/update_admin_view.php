		...
		<div class="page-content">
			...
			<div class="portlet">
                            ...
                            <div class="portlet-body form">
                                    ...
                                    <?php echo form_open(base_url('admin/Manage_Admin/update'.$data['admin']['admin_id'])); ?>
                                    
                                            <div class="form-body">
                                                    <div class="form-group">
                                                            <label class="control-label col-md-3">Name</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="name" placeholder="e.g John Dave" value="<?php echo($data['admin']['admin_name']); ?>" class="form-control" required="true"/>
                                                            </div>
                                                    </div>
                                                    <div class="form-group">
                                                            <label class="control-label col-md-3">Email</label>
                                                            <div class="col-md-9">
                                                                <input type="email" name="email" placeholder="e.g example@mail.com" value="<?php echo($data['admin']['admin_email']); ?>" class="form-control" required="true"/>
                                                            </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="contact" placeholder="e.g +x xxx-xxx-xxxx" class="form-control" value="<?php echo($data['admin']['admin_contact']); ?>" required="true"/>
                                                            </div>
                                                    </div>
