		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?= base_url("admin/Manage_Skill"); ?>">Manage Skills</a>
                                                <i class="fa fa-angle-right"></i>
					</li>
                                        <li>
						<a href="#">Manage Skill Types</a>
                                                <i class="fa fa-angle-right"></i>
					</li>
                                        <li>
                                            <a href="#">List</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bars"></i>List of Skill Types
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?= base_url('admin/Manage_Skill/add_skill_type'); ?>" class="btn btn-success">
							...
							<tr class="odd gradeX">
								<td>
                                                                    <?php echo $data['skill_type'][$i]['sktyp_id']; ?>
								</td>
                                                                <td style="border-right:0px;">
                                                                   <?php echo $data['skill_type'][$i]['sktyp_name']; ?>
								</td>
                                                                ...
                                                                <td>
									<a href="<?= base_url('admin/Manage_Skill/edit_skill_type'); ?>/<?php echo $data['skill_type'][$i]['sktyp_id']; ?>" class="btn btn-sm btn-success">
									Edit </a>
								</td>
                                                                <td>
									<a onclick="deleteMe('<?php echo $data['skill_type'][$i]['sktyp_id']; ?>');" class="btn btn-sm btn-danger">
									Delete </a>
								</td>
							</tr>
                                                        <?php }}}  else { ?>
                     ...
                     function deleteMe(id){
                        ...
                        if(c==true)
                        {
                            var xmlhttp;
                                    ...
                                    xmlhttp.open("POST","<?= base_url(); ?>admin/Manage_Skill/delete_skill_type/"+id,true);
                                    xmlhttp.send();
                        }
                        else{
