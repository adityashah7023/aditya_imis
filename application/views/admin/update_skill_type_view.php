		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?= base_url(); ?>admin/Manage_Skill/skill_type">Manage Skill Types</a>
                                                <i class="fa fa-angle-right"></i>
					</li>
                                        <li>
                                            <a href="#">Edit</a>
			...
			<div class="portlet">
                            ...
                            <div class="portlet-body form">
                                <div class="form-horizontal form-row-seperated">
                                    <!-- BEGIN FORM-->
                                    <?php echo form_open(base_url('admin/Manage_Skill/update_skill_type/'.$data["skill_type"]["sktyp_id"])); ?>
                                            <div class="form-body">
                                                    <div class="form-group">
                                                            <label class="control-label col-md-3">Name</label>
                                                            <div class="col-md-9">
                                                                <input type="text" name="name" class="form-control" required="true" value="<?php echo $data['skill_type']['sktyp_name']; ?>"/>
                                                            </div>
                                                    </div>
                                            ...
                                            <div class="form-actions">
                                                    <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                                    ...
                                                                    <a href="<?= base_url('admin/Manage_Skill/skill_type'); ?>" class="btn btn-default">Cancel</a>
                                                            </div>
                                                    </div>
                                            </div>
                                     <?php echo form_close(); ?>
