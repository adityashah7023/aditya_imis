...
<div class="logo">
	 <!--<a href=""> -->
         <img src="<?= base_url(); ?>assets/img/logo3.png" alt="Internship Management Information System" title="Internship Management Information System"/><br/><img style="margin-top: 10px;" src="<?= base_url(); ?>assets/img/logo4.png"/>
	<!--</a>-->
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	<!-- BEGIN LOGIN FORM -->
        ...
        <?php echo form_open(base_url('admin/C_Verifylogin')); ?>
		...
		<div class="form-group">
			...
			<div class="input-icon">
				<i class="fa fa-user"></i>
                                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="username" required="true"/>
			</div>
		</div>
		<div class="form-group">
