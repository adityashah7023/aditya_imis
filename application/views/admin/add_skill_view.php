			...
			<div class="portlet">
                            ...
                            <div class="portlet-body form">
                                <div class="form-horizontal form-row-seperated">
                                    <!-- BEGIN FORM-->
                                    <?php echo form_open(base_url('admin/Manage_Skill/insert')); ?>
                                            <div class="form-body">
                                                    <div class="form-group">
                                                            ...
                                                            <div class="col-md-7">
                                                                <select class="form-control" name="type" required="true">
                                                                    ...
                                                                    <option value="<?php echo $data['skill_type'][$i]['sktyp_id']; ?>" <?php echo set_select('type',$data['skill_type'][$i]['sktyp_id']); ?>><?php echo $data['skill_type'][$i]['sktyp_name']; ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                            <div class='col-md-2'>
