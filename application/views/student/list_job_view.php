		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?= base_url("student/List_Company"); ?>">Companies</a>
                                                <i class="fa fa-angle-right"></i>
					</li>
                                        <li>
                                                                        ...
                                                                        <tr class="odd gradeX">
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <?php } else { $flag=0;
                                                                                        ...
                                                                                        if($flag==0) {?>
                                                                                        <a href="<?= base_url('student/Job/apply'); ?>/<?php echo $data['job'][$i]['job_id']; ?>/<?php echo $this->uri->segment(2); ?>/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>" class="btn btn-sm btn-success col-md-12">
                                                                                            Apply Now</a>
                                                                                    <?php } else { ?>
