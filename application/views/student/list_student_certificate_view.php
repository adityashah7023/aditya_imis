				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bars"></i>List of Certificates
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<a href="<?= base_url('student/Certificate/add'); ?>" class="btn btn-success">
							...
							<tbody>
                                                        <?php
                                                        if($data['student_certificate']['count']!=0){
                                                            for($i=0;$i<$data['student_certificate']['count'];$i++){
                                                                if($data['student_certificate'][$i]['stce_status']=="enable"){
                                                        ?>
							<tr class="odd gradeX">
								<td>
									 <?php echo $i+1; ?>
								...
								<td>
									<?php echo $data['student_certificate'][$i]['certification']['cert_name']; ?>
								</td>
								<td>
									 <?php echo $data['student_certificate'][$i]['certification']['cert_body']; ?>
								</td>
								<td >
									<?php echo $data['student_certificate'][$i]['stce_received_date']; ?>
								</td>
                                                                <td style="border-right: 0px;">
									<a onclick="deleteMe('<?php echo $data['student_certificate'][$i]['stce_id']; ?>');" class="btn btn-sm btn-danger">
									Remove </a>
								</td>
							</tr>
                                                            <?php }}}  else { ?>
                                                    ...
                                                    function deleteMe(id){
                                                        ...
                                                        if(c==true)
                                                        {
                                                            var xmlhttp;
                                                                    ...
                                                                    xmlhttp.open("POST","<?= base_url(); ?>student/Certificate/delete/"+id,true);
                                                                    xmlhttp.send();
                                                        }
                                                        else{
