                                                                        ...
                                                                        <tr class="odd gradeX">
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <?php } else { $flag=0;
                                                                                        ...
                                                                                        if($flag==0) {?>
                                                                                        <a href="<?= base_url('student/Job/apply'); ?>/<?php echo $data['job'][$i]['job_id']; ?>/<?php echo $this->uri->segment(2); ?>/<?php echo $this->uri->segment(3); ?>" class="btn btn-sm btn-success col-md-12">
                                                                                            Apply Now</a>
                                                                                    <?php } else { ?>
