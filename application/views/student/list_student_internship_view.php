		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?= base_url("student/Manage_Student"); ?>">Manage Students</a>
                                                <i class="fa fa-angle-right"></i>
					</li>
                                        <li>
					...
					<div class="tabbable tabbable-custom">
						...
						<div class="tab-content">
							...
							<tr class="odd gradeX">
								...
								<td class="center">
                                                                    <div class="col-sm-12"><?php echo $data['student_intern'][$i]['stin_start_date']; ?></td><td><?php echo $data['student_intern'][$i]['stin_end_date']; ?></div>
								</td>
