					...
					<div class="modal-content">
						<div class="modal-header bg-danger">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                        <h4 class="modal-title"><b>New Degree</b></h4>
						</div>
                                                <?php echo form_open(base_url('student/Education/insert')); ?>
                                                    ...
                                                    <!-- BEGIN FORM-->
                                                            ...
                                                            <div class="form-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-9">
                                                                                <input type="text" name="major" placeholder="e.g. Computer Science" class="form-control" required="true"/>
                                                                            </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                            <label class="control-label col-md-3">University Name</label>
                                                                            <div class="col-md-9">
                                                                                <input type="text" name="uni_name" class="form-control" required="true"/>
                                                                            </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                            <label class="control-label col-md-3">University City</label>
                                                                            <div class="col-md-9">
                                                                                <input type="text" name="uni_city" class="form-control" required="true"/>
                                                                            </div>
                                                                    </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-9">
                                                                                <input type="text" name="gpa" placeholder="Note: Must be out of 4" class="form-control" required="true"/>
                                                                            </div>
                                                                    </div>
                                                            </div>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							...
							<tbody>
                                                        <?php
                                                        if($data['student_education']['count']!=0){
                                                            for($i=0;$i<$data['student_education']['count'];$i++){
                                                                if($data['student_education'][$i]['sted_status']=="enable"){
                                                        ?>
							<tr class="odd gradeX">
								<td>
									 <?php echo $i+1; ?>
								...
								<td>
									<?php echo $data['student_education'][$i]['sted_degree_name']." in ".$data['student_education'][$i]['sted_major']; ?>
								</td>
								<td>
									 <?php echo $data['student_education'][$i]['sted_uni_name'].", ".$data['student_education'][$i]['sted_uni_city']; ?>
								</td>
                                                                <td >
									<?php echo $data['student_education'][$i]['sted_start_year']." - ".$data['student_education'][$i]['sted_end_year']; ?>
								</td>
								<td >
									<?php echo $data['student_education'][$i]['sted_gpa']; ?>
								</td>
                                                                <td style="border-right: 0px;">
									<a onclick="deleteMe('<?php echo $data['student_education'][$i]['sted_id']; ?>');" class="btn btn-sm btn-danger">
									Remove </a>
								</td>
							</tr>
                                                            <?php }}}  else { ?>
                                                    ...
                                                    function deleteMe(id){
                                                        ...
                                                        if(c==true)
                                                        {
                                                            var xmlhttp;
                                                                    ...
                                                                    xmlhttp.open("POST","<?= base_url(); ?>student/Education/delete/"+id,true);
                                                                    xmlhttp.send();
                                                        }
                                                        else{
